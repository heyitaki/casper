...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "nextSession", combos: [["⌘", "↓"]], description: { en: "Next session", ja: "次のセッション" } },
      { id: "prevSession", combos: [["⌘", "↑"]], description: { en: "Previous session", ja: "前のセッション" } },
      { id: "nextSessionWorkspace", combos: [["⌘", "⇧", "↓"]], description: { en: "Next session workspace", ja: "次のセッションのワークスペース" } },
      { id: "prevSessionWorkspace", combos: [["⌘", "⇧", "↑"]], description: { en: "Previous session workspace", ja: "前のセッションのワークスペース" } },
      {
        id: "focusHistoryBack",
        combos: [["⌘", "["]],
