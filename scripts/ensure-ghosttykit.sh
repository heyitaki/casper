...
try_fetch_prebuilt_xcframework() {
  ...
  # CASPER: prebuilt GhosttyKit comes from heyitaki/ghostty fork releases; delete if heyitaki/cmux retires.
  local url="https://github.com/heyitaki/ghostty/releases/download/xcframework-${GHOSTTY_CLEAN_KEY}/GhosttyKit.xcframework.tar.gz"
