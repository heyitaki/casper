...
class TabManager: ObservableObject {
    ...
    /// Each member is recorded individually by upstream's closed-item history,
    /// so undo currently reopens them one at a time rather than as a single
    /// group step. Delete with the group-close feature.
